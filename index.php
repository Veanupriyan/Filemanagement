...
<form action="login.php" method="post">
			...
			<font style=" font:bold 44px 'Aleo'; text-shadow:1px 1px 15px #000; color:#fff;"><center>ZEO Batticaloa
		</center></font>
		<br>
...
<button class="btn btn-medium btn-primary btn-block pull-right" href="dashboard.html" type="submit">Forget</button>
